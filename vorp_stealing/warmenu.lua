...
local function drawTitle()
	if menus[currentMenu] then
		...
		if HasStreamedTextureDictLoaded("menu_textures") and HasStreamedTextureDictLoaded("generic_textures") then
			...
			DrawSprite("menu_textures", "translate_bg_1a", x, y +0.26, 0.28, 0.70, 180.8, 000, 2, 2, 100, 1)
			DrawSprite("generic_textures", "menu_header_1a", x, y, menus[currentMenu].width + .03, titleHeight, 0.0, 255, 40, 40, 100, 0)
		end
		DrawSprite("generic_textures", "list_item_h_line_narrow", x, y + 0.0799, menus[currentMenu].width+ 0.01, 0.003, 0.0, 255, 40, 40, 100, 0)
...
local function drawSubTitle()
	if menus[currentMenu] then
		...
		if HasStreamedTextureDictLoaded("generic_textures") then
			...
			DrawSprite("generic_textures", "selection_box_bg_1d", x, y - 0.002, menus[currentMenu].width + 0.01 , buttonHeight, 0.0, 0, 0, 0, 100, 0)
		end
	...
	if multiplier then
		...
		if menus[currentMenu].currentOption == optionCount then
			if HasStreamedTextureDictLoaded("generic_textures") then
				...
				DrawSprite("generic_textures", "selection_box_bg_1d", x, y - 0.002, menus[currentMenu].width+ 0.01, buttonHeight, 0.0, 255, 40, 40, 150, 0)
			end
		else
			if HasStreamedTextureDictLoaded("generic_textures") then
				SetScriptGfxDrawOrder(1)
				DrawSprite("generic_textures", "selection_box_bg_1d", x, y - 0.002, menus[currentMenu].width+ 0.01, buttonHeight, 0.0, 0, 0, 0, 50, 0)
			end
		end
...
function WarMenu.CreateMenu(id, title)
	...
	menus[id].subTitle = Config.Language.mainmenusubtitle
	...
	menus[id].titleBackgroundColor = { r = 255, g = 255, b = 255, a = 0 }
	menus[id].titleBackgroundSprite = nil

	menus[id].menuTextColor = { r = 255, g = 255, b = 255, a = 255 }
	menus[id].menuSubTextColor = { r = 255, g = 255, b = 255, a = 0 }
	menus[id].menuFocusTextColor = { r = 0, g = 0, b = 0, a = 255 }
	menus[id].menuFocusBackgroundColor = { r = 245, g = 245, b = 245, a = 255 }
	menus[id].menuBackgroundColor = { r = 0, g = 0, b = 0, a = 50 }

	menus[id].subTitleBackgroundColor = { r = menus[id].menuBackgroundColor.r, g = menus[id].menuBackgroundColor.g, b = menus[id].menuBackgroundColor.b, a = 50 }
